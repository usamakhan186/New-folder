...
const HeroSection = () => {
    ...
    const stats = [
        { value: '54k+', label: 'Cars traded' },
        { value: '50k+', label: 'Cars listed' },
        { value: '4.5k+', label: 'Reviews' },
    ];


    return (
        <div className="bg-[#ffeded] min-h-screen pb-12">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 lg:pt-32">
                <div className="flex flex-col md:flex-row md:space-x-12 space-y-12 md:space-y-0">
                    ...
                    <div className="space-y-8 mr-8">
                        <div>
                            <h1 className="text-4xl lg:text-5xl font-medium mb-4 mt-8">
                                Helping you to<br />sell your car faster
                            </h1>
                    ...
                    {/* Search Form */}
                    <div className="bg-white bg-opacity-50 rounded-2xl p-6 shadow-lg md:w-[47%] h-fit">
                        <div className="flex justify-between items-center mb-8">
                            <h2 className="text-xl font-semibold">Personalized your search</h2>
                            <div className="flex gap-1 bg-red-100 p-1 rounded-lg">
                                <button className="bg-red-500 text-white px-4 py-1 rounded text-sm">
                                    Used
                                </button>
                                <button className="text-gray-700 px-4 py-1 rounded text-sm">
                                    New
                                </button>
                            </div>
                        </div>
